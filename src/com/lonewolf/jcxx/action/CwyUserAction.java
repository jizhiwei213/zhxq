...
public class CwyUserAction extends BaseAction {
	...
	public String cwyIndex(){
		return SUCCESS;
	}
	
	public String cwyList(){
		Integer start=null;
	...
	public String cwyEdit(){
		...
		List<RoleModel> roleList=roleService.getRoleListByRoleId(null, null, "30000000000000000000000000000000");
		ActionContext.getContext().put("roleList", roleList);
		return SUCCESS;
	}
	
	public String cwySaveUpdate()throws Exception{
