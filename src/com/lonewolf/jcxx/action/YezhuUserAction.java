...
public class YezhuUserAction extends BaseAction {
	...
	public String yezhuIndex(){
		return SUCCESS;
	}
	
	public String yezhuList(){
		Integer start=null;
	...
	public String yezhuEdit(){
		...
		List<RoleModel> roleList=roleService.getRoleListByRoleId(null, null, "402881e958fb84910158fb876b270004");
		ActionContext.getContext().put("roleList", roleList);
		return SUCCESS;
	}
	
	public String yezhuSaveUpdate()throws Exception{
