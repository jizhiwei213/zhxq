...
public class YwyUserAction extends BaseAction {
	...
	public String ywyEdit(){
		...
		List<RoleModel> roleList=roleService.getRoleListByRoleId(null, null, "402880ee48592bf80148592d98060038");
		ActionContext.getContext().put("roleList", roleList);
		return SUCCESS;
	}
	
	public String ywySaveUpdate()throws Exception{
