...
public class GsqUserAction extends BaseAction {
	...
	public String gsqUserIndex(){
		return SUCCESS;
	}
	
	public String gsqUserList(){
		Integer start=null;
		...
		userQuery.setUserType("4");
		UserModel use = (UserModel)getSession().getAttribute("user");
		userQuery.setNotUserId(use.getId());
	...
	public String gsqUserEdit(){
		...
		List<RoleModel> roleList=roleService.getRoleListByRoleId2(null, null, "40288191587ab0bc01587ad280080010","2c9086655cce5013015cce81028a0000");
		ActionContext.getContext().put("roleList", roleList);
		return SUCCESS;
	}
	
	public String gsqUserSaveUpdate()throws Exception{
