...
public class QyglyUserAction extends BaseAction {
	...
	public String qyglyIndex(){
		return SUCCESS;
	}
	
	public String qyglyList(){
		Integer start=null;
	...
	public String qyglyEdit(){
		...
		List<RoleModel> roleList=roleService.getRoleListByRoleId(null, null, "10000000000000000000000000000000");
		ActionContext.getContext().put("roleList", roleList);
		return SUCCESS;
	}
	
	public String qyglySaveUpdate()throws Exception{
