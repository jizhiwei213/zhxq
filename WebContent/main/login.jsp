...
<html>
	...
	<tr>
		...
		<td colspan="2" background="<n:base/>/images/psd6694_09.gif"  width="219" height="31" >
				&nbsp;<input name="userAccount" type="text" id="userAccount"  style="width:200" tabindex="1"  />
		</td>
		<td rowspan="4">
		...
		<td rowspan="3">
			<img src="<n:base/>/images/psd6694_12.gif" width="63" height="81" alt="" border="0" onClick="regist()"></td>
		<td>
	...
	<tr>
		...
		&nbsp;<input type="password" name="userPassword" id="userPassword"  style="width:200" tabindex="2"  /> 
		</td>
		<td>
	...
	<tr>
		...
		<td>
			<img src="<n:base/>/images/psd6694_19.gif" width="63"  height="28" alt=""></td>
		<td>
			<img src="<n:base/>/images/psd6694_19.gif" width="63"  height="28" alt=""></td>
		<td>
	...
	<tr>
		<td colspan="8">
			<img src="<n:base/>/images/psd6694_20.gif" width="507" height="198" alt=""></td>
		<td>
		...
		<script type="text/javascript">
			...
			function regist()
			{
				window.location.href="<n:base/>/main/regist.jsp";
			}
		</script>
	</body>
</html>
