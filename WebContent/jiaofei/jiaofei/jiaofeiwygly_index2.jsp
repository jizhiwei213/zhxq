...
<html>
	...
	<body>
		...
		<div id="tb_datagrid1_<s:property value='rand'/>">
			<div>
				<span>&nbsp;&nbsp;&nbsp;&nbsp;<input style="width:1000px;height:24px;" type="text" id="monthQ" name="monthQ" value="DDDDDDDDDD" class="easyui-validatebox" /></span>
			</div>
		</div>
		...
		<script type="text/javascript">
			$(function(){
				$("#datagrid_<s:property value='rand'/>").datagrid({
					url:'<n:base/>/jcxx/zhxqJiaofeiWyglyList2.action',
					title: '缴费信息',
					loadMsg: '数据正在加载中请稍候......',
			        striped: true,
			        fit: true,
