...
<html>
	...
	<body>
		<center>
		<form id="userForm_edit" action="<n:base/>/yhqx/userSaveUpdate.action" style="margin:0px;padding:0px;width:100%;"  method="post" enctype="multipart/form-data" >
			...
			<table class="bdtable">
				...
				<tr>
					...
					<td align="left">
					<input type="file" style="width:157px;"  id="uploadFile" name="uploadFile" class="easyui-validatebox" data-options="required:false"/>
					</td>
				</tr>	
			</table>
		</form>
