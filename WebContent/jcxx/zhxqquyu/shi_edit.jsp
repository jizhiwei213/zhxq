...
<html>
	...
	<body>
		...
		<form id="editForm" action="<n:base/>/jcxx/zhxqShiSaveUpdate.action" style="margin:0px;padding:0px;width:100%;height:100%;">
			<s:token/>
			<input type="hidden" name="zhxqShiModel.id" value="<s:property value='zhxqShiModel.id' />">
			<table class="bdtable" cellpadding="2">
				<tr>
					<td align="right">名称：</td>
					<td align="left"><input style="width:170px;height:24px;" type="text" name="zhxqShiModel.name" value="<s:property value='zhxqShiModel.name' />" class="easyui-validatebox" data-options="required:true" /></td>
				</tr>
				<tr>
					<td align="right">所在省份：</td>
					<td align="left"><input style="width:170px;height:24px" type="text" name="zhxqShiModel.shen.id" class="easyui-combotree"  value="<s:property value='zhxqShiModel.shen.id' />"  data-options="panelHeight:'auto',url:'<n:base/>/jcxx/comboBoxShenJsonArrayData.action',required:true" /></td>
				</tr>
			</table>
		</form>
		</div>
