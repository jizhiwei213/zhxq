...
<html>
	...
	<body>
		<center>
		<form id="userForm_edit" action="<n:base/>/jcxxyhgl/wyrySaveUpdate.action" style="margin:0px;padding:0px;width:100%;"  method="post" enctype="multipart/form-data" >
			...
			<input type="hidden" name="userModel.usertype" value="<s:property value='2' />">
			<table class="bdtable">
				<tr>
				...
				<tr>
					...
					<td align="left">
						<input type="text" name="userModel.wygs.id" value="<s:property value='userModel.wygs.id' />" class="easyui-combotree" data-options="panelHeight:'auto',url:'<n:base/>/jcxx/comboBoxWygsJsonArrayData.action',required:true" />
					</td>
					<td align="right">归属小区：</td>
					<td align="left">
						<input type="text" name="userModel.xiaoqu.id" value="<s:property value='userModel.xiaoqu.id' />" class="easyui-combotree" data-options="panelHeight:'auto',url:'<n:base/>/jcxx/comboBoxXiaoquJsonArrayData.action',required:true" />
					</td>
				</tr>
				<tr>
