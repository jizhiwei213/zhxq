...
<html>
	...
	<body>
		<center>
		<form id="userForm_edit" action="<n:base/>/jcxxyhgl/yezhuSaveUpdate.action" style="margin:0px;padding:0px;width:100%;"  method="post" enctype="multipart/form-data" >
			...
			<input type="hidden" name="userModel.usertype" value="<s:property value='8' />">
			<table class="bdtable">
				<tr>
