var groupViewCheckbox = $.extend({}, $.fn.datagrid.defaults.view, {
	...
	renderGroup: function(target, groupIndex, group, frozen){
		...
		if (!frozen){
			table.push('<div class="datagrid-header-check"><input type="checkbox" name="groupCheckbox" id="'+group.value+'"></div>');
			table.push('</td>');
			table.push('<td style="border:0;">');
